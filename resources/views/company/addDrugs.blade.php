        ...
        <div class="form-inline">
            <form method="POST" action="{{ route('drugs.store') }}" enctype="multipart/form-data">
                ...
                <div class="col-xs-12">
                    <div class="col-xs-5 col-xs-offset-1 well">
                        <div class="form-group">
                            ...
                            <input type="text" required placeholder="Enter drugs name" class="form-control" name="name"
                                id="name">
                    ...
                    <div class="col-xs-5 col-xs-offset-1 well">
                        <div class="form-group">
                            ...
                            <input required type="date" placeholder="Enter Best Before Date:" class="form-control"
                                name="expiring_date" id="expiring_date">
                ...
                <div class="col-xs-11 col-xs-offset-1">
                    <div class="form-group">
                        <input type="submit" value="Enter Details" class="form-control"
